...
entity per_Adani_Logistics_LRF_Master : managed {
    ...
    Checklist_Approval_Status: String @(title: 'Checklist Approval Status (by MPL)');
        ...
        CustomsMPL_Comments        :      String default null @(title: 'CustomsMPL Comments');
        ...
        CustomsMPL_Status          :      String default null @(title: 'CustomsMPL Status');
        ...
        CustomsMPL_AssignEmail_Id  :      String @(title: 'CustomsMPL Email ID');
        ...
        CustomsMPL_Allocation_Date :      Date default CURRENT_DATE @(title: 'CustomsMPL Allocation Date');
